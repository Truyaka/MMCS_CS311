...
// DateTime: 15.11.2019 20:02:53
// UserName: user
// Input file <SimpleYacc.y - 15.11.2019 19:53:44>
...
public enum Tokens {
    ...
    COLUMN=19,REMINDER=20,WHILE=21,NE=22,INUM=23,RNUM=24,
    ID=25};
...
#pragma warning restore 649
  ...
  private static string[] nonTerms = new string[] {
      ...
      "write", "empty", "var", "varlist", "while", "stlist", "$accept", "Anon@1", 
      };
...
{ CurrentSemanticValue.stVal = new CycleNode(ValueStack[ValueStack.Depth-2].eVal,ValueStack[ValueStack.Depth-1].stVal); }
        break;
      case 27: // while -> WHILE, assign, NE, expr, statement
{ CurrentSemanticValue.stVal = new WhileNode(ValueStack[ValueStack.Depth-4].stVal as AssignNode, ValueStack[ValueStack.Depth-2].eVal, ValueStack[ValueStack.Depth-1].stVal); }
        break;
