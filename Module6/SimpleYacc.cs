...
// DateTime: 01.11.2019 21:40:45
// UserName: user
// Input file <SimpleYacc.y - 01.11.2019 21:40:35>
...
{
  // Verbatim content from SimpleYacc.y - 01.11.2019 21:40:35
// Ýòè îáúÿâëåíèÿ äîáàâëÿþòñÿ â êëàññ GPPGParser, ïðåäñòàâëÿþùèé ñîáîé ïàðñåð, ãåíåðèðóåìûé ñèñòåìîé gppg
    public BlockNode root; // Êîðíåâîé óçåë ñèíòàêñè÷åñêîãî äåðåâà 
    public Parser(AbstractScanner<ValueType, LexLocation> scanner) : base(scanner) { }
  // End verbatim content from SimpleYacc.y - 01.11.2019 21:40:35
...
#pragma warning restore 649
  ...
  private static string[] nonTerms = new string[] {
      "expr", "ident", "e1", "e2", "e3", "assign", "statement", "cycle", "while", 
  ...
  static Parser() {
    ...
    states[4] = new State(new int[]{28,19,3,4,5,33,10,37},new int[]{-10,5,-7,42,-6,9,-2,10,-11,31,-8,32,-9,36});
    states[5] = new State(new int[]{4,6,7,7});
    states[6] = new State(-13);
    states[7] = new State(new int[]{28,19,3,4,5,33,10,37},new int[]{-7,8,-6,9,-2,10,-11,31,-8,32,-9,36});
    ...
    states[13] = new State(new int[]{22,14,23,29,4,-12,7,-12,18,-12,28,-12,3,-12,5,-12,10,-12,11,-12});
    states[14] = new State(new int[]{28,19,26,20,27,21,17,22},new int[]{-4,15,-5,28,-2,18});
    states[15] = new State(new int[]{24,16,25,26,22,-15,23,-15,4,-15,7,-15,18,-15,28,-15,3,-15,5,-15,10,-15,11,-15});
    ...
    states[25] = new State(new int[]{24,16,25,26,22,-14,23,-14,4,-14,7,-14,18,-14,28,-14,3,-14,5,-14,10,-14,11,-14});
    ...
    states[30] = new State(new int[]{24,16,25,26,22,-16,23,-16,4,-16,7,-16,18,-16,28,-16,3,-16,5,-16,10,-16,11,-16});
    states[31] = new State(-4);
    states[32] = new State(-5);
    states[33] = new State(new int[]{28,19,26,20,27,21,17,22},new int[]{-1,34,-3,13,-4,25,-5,28,-2,18});
    states[34] = new State(new int[]{28,19,3,4,5,33,10,37},new int[]{-7,35,-6,9,-2,10,-11,31,-8,32,-9,36});
    states[35] = new State(-24);
    states[36] = new State(-6);
    states[37] = new State(new int[]{28,19,26,20,27,21,17,22},new int[]{-1,38,-3,13,-4,25,-5,28,-2,18});
    states[38] = new State(new int[]{11,39});
    states[39] = new State(new int[]{28,19,3,4,5,33,10,37},new int[]{-10,40,-7,42,-6,9,-2,10,-11,31,-8,32,-9,36});
    states[40] = new State(new int[]{4,41,7,7});
    ...
    rules[3] = new Rule(-7, new int[]{-6});
    rules[4] = new Rule(-7, new int[]{-11});
    rules[5] = new Rule(-7, new int[]{-8});
    rules[6] = new Rule(-7, new int[]{-9});
    rules[7] = new Rule(-10, new int[]{-7});
    rules[8] = new Rule(-10, new int[]{-10,7,-7});
    rules[9] = new Rule(-9, new int[]{10,-1,11,-10,4});
    rules[10] = new Rule(-2, new int[]{28});
    rules[11] = new Rule(-6, new int[]{-2,6,-1});
    rules[12] = new Rule(-1, new int[]{-3});
    rules[13] = new Rule(-11, new int[]{3,-10,4});
...
{ root = ValueStack[ValueStack.Depth-1].blVal; }
        break;
      case 3: // statement -> assign
{ CurrentSemanticValue.stVal = ValueStack[ValueStack.Depth-1].stVal; }
        break;
      case 4: // statement -> block
{ CurrentSemanticValue.stVal = ValueStack[ValueStack.Depth-1].blVal; }
        break;
      case 5: // statement -> cycle
{ CurrentSemanticValue.stVal = ValueStack[ValueStack.Depth-1].stVal; }
        break;
      case 6: // statement -> while
{ CurrentSemanticValue.stVal = ValueStack[ValueStack.Depth-1].stVal; }
        break;
      case 7: // stlist -> statement
{ 
				CurrentSemanticValue.blVal = new BlockNode(ValueStack[ValueStack.Depth-1].stVal); 
			}
        break;
      case 8: // stlist -> stlist, SEMICOLON, statement
{ 
        ...
        break;
      case 9: // while -> WHILE, expr, DO, stlist, END
{
				CurrentSemanticValue.stVal = new WhileNode(ValueStack[ValueStack.Depth-2].blVal as BlockNode, ValueStack[ValueStack.Depth-4].eVal as ExprNode);
			}
        break;
      case 10: // ident -> ID
...
{ CurrentSemanticValue.eVal = new BinaryOperation(ValueStack[ValueStack.Depth-3].eVal as ExprNode,ValueStack[ValueStack.Depth-1].eVal as ExprNode, OperationType.MINUS);}
        break;
      case 16: // e1 -> e1, PLUS, e2
{ CurrentSemanticValue.eVal = new BinaryOperation(ValueStack[ValueStack.Depth-3].eVal as ExprNode,ValueStack[ValueStack.Depth-1].eVal as ExprNode, OperationType.PLUS);}
        break;
      case 17: // e2 -> e3
{ CurrentSemanticValue.eVal = ValueStack[ValueStack.Depth-1].eVal as ExprNode; }
        break;
      case 18: // e2 -> e2, MULT, e3
{ CurrentSemanticValue.eVal = new BinaryOperation(ValueStack[ValueStack.Depth-3].eVal as ExprNode,ValueStack[ValueStack.Depth-1].eVal as ExprNode, OperationType.MULT);}
        break;
      case 19: // e2 -> e2, DELIM, e3
{ CurrentSemanticValue.eVal = new BinaryOperation(ValueStack[ValueStack.Depth-3].eVal as ExprNode,ValueStack[ValueStack.Depth-1].eVal as ExprNode, OperationType.DELIM);}
        break;
      case 20: // e3 -> ident
